...
stheta = 58.8  # angle of satellite compared to Jupiter (degrees)


initial_state = [0, 0, 0, ve0, -r0, -r0*1, vs0*np.cos(np.radians(stheta)), vs0*np.sin(np.radians(stheta))]  # [x_jupiter, y_jupiter, vx_jupiter, vy_jupiter, x_sat, y_sat, vx_sat, vy_sat]
...
jupiter, = ax1.plot([], [], 'o', color='cyan', markersize=10)  
...
plt.title(label="Orbital Swingby (Velocity Loss Case)", fontsize=20, color="white")
